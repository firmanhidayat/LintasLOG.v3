...
>({
  ...
  /** === NEW === */
  /** Nama field key selain "id" (mis. "key", "uuid", "code") */
  rowKey?: string;
  ...
  // ======== Sort defaults: rowKey DESC if not explicitly set ========
  ...
  const sortedItems = useMemo(() => {
    ...
    // Case 1: ada kolom sortable + sortValue
    ...
    // Case 2 (NEW): fallback sort khusus untuk rowKey meskipun tidak ada kolom
    if (sortBy === rowKey) {
      arr.sort((a, b) => {
    ...
    // Jika tidak memenuhi syarat, kembalikan apa adanya
    return arr;
